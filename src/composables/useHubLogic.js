...
import { dateIso, moneyFull, percent } from '../format.js';
import {
  safeNumber, fmtMoneyPrompt, fmtPctPrompt, toPeriodYYYYMM,
  signedMoneyFull, signedMoneyFullNoDecimals, moneyFullNoDecimals,
  fullMoneyFromTimeSeries, normalizeText, formatDesembolsoMiles,
  trendClass, moneyKFull, signedMoneyK
...
const draftSelectedProjProducts = ref([...DEFAULT_PRODUCTOS]);
const oficialesFirst = ref(0);
const captacionHistoricoProducto = ref('TOTAL');
...
async function loadProjectionByProduct() {
  for (const prod of selectedProjProducts.value) {
    if (!projectionProductData.value[prod]) {
      try {
        projectionProductData.value[prod] = await dataStore.fetchMergedProjectionByProduct(prod);
      } catch (error) {
...
async function applyProjectionFilters() {
  ...
  const params = filtersStore.getAppliedParams();
  try {
    projection.value = await dataStore.fetchMergedProjection(params);
...
const oportunidadesResumenOptions = {
  ...
  return reactive({
    ...
    fullMoneyFromTimeSeries, normalizeText, formatDesembolsoMiles,
    trendClass, moneyKFull, signedMoneyK,
    applyProjectionFilters, loadProjectionByProduct,
    DEFAULT_PRODUCTOS,
    PALETTE,
    ...
    buildProjectionAxis,
    captacionCategorySeverity,
    captacionFugaLevelFromCategory,
    captacionHistoricoProducto,
    captacionesBarOptions,
    captacionesByAgencia,
    captacionesBySucursal,
    captacionesFugaChart,
    captacionesFugaRows,
    captacionesFugaTotals,
    captacionesHistoricoChart,
    captacionesHistoricoLineOptions,
    captacionesHistoricoRows,
    captacionesHorizontalOptions,
    captacionesPeriod,
    captacionesProductoChart,
    captacionesStockBudgetChart,
    captacionesStockBudgetOptions,
    captacionesStockBudgetRows,
    captacionesSucursalChart,
    captacionesTotals,
    captacionesTrendChart,
    captacionesTrendRows,
    chartFilters,
    chartOptions,
    compositionChart,
    creditCountValue,
    draftProjectionMetric,
    draftSelectedProjProducts,
    fetchMergedProjection,
    fetchMergedProjectionByProduct,
    filteredBenchmark,
    filteredMarketShare,
    flowChart,
    flowRows,
    fullMoneyFromTimeSeries,
    isCaptacionFugaCategory,
    lcfAgenciaChart,
    lcfByAgency,
    lcfByProduct,
    lcfCupoNoUtilizadoValue,
    lcfDetalleRows,
    lcfProductoChart,
    lcfSaldoActivadoValue,
    lcfTotals,
    loadProjectionByProduct,
    maduracionAgenciaChart,
    maduracionAlertIcon,
    maduracionAlertLevel,
    maduracionAlertSeverity,
    maduracionBandChart,
    maduracionBandChartOptions,
    maduracionBandRows,
    maduracionByAgency,
    maduracionByProduct,
    maduracionDetalleAgenciaRows,
    maduracionProductoChart,
    maduracionRiskOrder,
    maduracionRuleText,
    maduracionSemaforoRows,
    maduracionSucursalProductoRows,
    maduracionTotals,
    marketChart,
    marketVisualRows,
    matrixCellClass,
    mergeProjectionScenarios,
    moneyFullNoDecimals,
    normalizeTipoDato,
    oficialesFirst,
    oportunidadesByAgencia,
    oportunidadesResumenChart,
    oportunidadesResumenOptions,
    oportunidadesTotals,
    opportunityMixedChartOptions,
    opportunityProduct,
    orgArea,
    pdRiskBarOptions,
    pdRiskByProduct,
    pdRiskBySucursal,
    pdRiskCriticalAgencies,
    pdRiskHistoryByPeriod,
    pdRiskHistoryChart,
    pdRiskHistoryLineOptions,
    pdRiskStackedOptions,
    pdRiskSucursalChart,
    pdRiskSucursalProductBreakdown,
    pdRiskTotals,
    portadaBestMarketSegment,
    portadaCriticalProducts,
    portadaExecutiveAlerts,
    portadaFastInsights,
    portadaFlowChartOptions,
    portadaGrowthLeaders,
    portadaGrowthLeadersPeriod,
    portadaIntegratedSummaryCards,
    portadaKpiCards,
    portadaOpportunityAgencyTop,
    portadaProductGoalChart,
    portadaProductGoalOptions,
    portadaProductGoalRows,
    portadaProductGoalTotals,
    portadaTopOfficials,
    portadaTopProducts,
    portadaUpdatedAt,
    productGrowthAmount,
    ...
    projectionMergeKey,
    projectionMetrics,
    projectionSelectedProductBase,
    projectionYearSummary,
    scatterChart,
    scatterOptions,
    sharedPortfolioAgencyRows,
    sharedPortfolioBankChart,
    sharedPortfolioBankTotals,
    sharedPortfolioBarOptions,
    sharedPortfolioDonutChart,
    sharedPortfolioMatrix,
    sharedPortfolioSegmentChart,
    sharedPortfolioSegmentRows,
    sharedPortfolioTotals,
    signedMoneyFull,
    signedMoneyFullNoDecimals,
    sortProjectionRows,
    toPeriodYYYYMM,
    tooltipBase,
    valueByTipoAndDate
